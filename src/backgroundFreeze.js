...
import { gameplayStart, gameplayStop, isGameplayActive } from "./platform/yandex.js";
...
function freeze() {
  ...
  resumeGameplay = isGameplayActive();
  if (resumeGameplay) gameplayStop();
  root.paused = true;
...
function thaw() {
  ...
  if (resumeGameplay) gameplayStart();
